...
import io.digitalstate.camunda.client.externaltask.models.fetchandlock.FetchAndLock;
import io.digitalstate.camunda.client.externaltask.models.fetchandlock.FetchAndLockTopic;
import io.digitalstate.camunda.worker.FetchAndLockVerticle;
...
//                .add("x-test2", "some-other-header-value");
        ...
        configObject.put("webClientOptions", Json.encode(new WebClientOptions()
                .setKeepAliveTimeout(600)
                .setHttp2KeepAliveTimeout(600)
                .setKeepAlive(true))); // 10 min long polling
